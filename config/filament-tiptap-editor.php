...
return [
    ...
    */
    'profiles' => [
        ...
        'digitonic' => ['heading', 'bullet-list', 'ordered-list', 'blockquote', 'hr', '|', 'bold', 'italic', 'strike',
            'underline', 'superscript', 'subscript', 'lead', 'small', 'color', 'highlight', 'align-left',
            'align-center', 'align-right', '|', 'link', 'media', 'oembed', 'table', '|', 'source', 'blocks', 'code',
        ],
        'barebone' => ['bold', 'italic', 'underline'],
    ],
    ...
    */
    ...
    | Filament Form FileUpload field.
    |
